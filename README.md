...
| `diskann2019`                  | *DiskANN: Fast Accurate Billion-point Nearest Neighbor Search on a Single Node*                            | Referencia de escala, memoria, latencia y diseño ANN                                     |
| `wang2021graphsurvey`          | *A Comprehensive Survey and Experimental Comparison of Graph-Based Approximate Nearest Neighbor Search*    | Survey de graph-based ANNS, taxonomía y componentes                                      |

Ubicación sugerida:

```text
documentos/corpus/principal/
```
